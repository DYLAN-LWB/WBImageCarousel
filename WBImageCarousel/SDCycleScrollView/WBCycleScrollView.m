...
- (void)initialization
{
    _pageControlAliment = WBCycleScrollViewPageContolAlimentCenter;
    ...
    _pageControlStyle = WBCycleScrollViewPageContolStyleAnimated;
...
{
    WBCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[WBCollectionViewCell class] forCellWithReuseIdentifier:ID];
...
- (void)setPageControlStyle:(WBCycleScrollViewPageContolStyle)pageControlStyle
{
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        case WBCycleScrollViewPageContolStyleAnimated:
        {
        ...
        case WBCycleScrollViewPageContolStyleClassic:
        {
...
- (void)layoutSubviews
{
    ...
    CGFloat x = (self.wb_width - size.width) * 0.5;
    if (self.pageControlAliment == WBCycleScrollViewPageContolAlimentRight) {
        x = self.mainView.wb_width - size.width - 10;
    }
    CGFloat y = self.mainView.wb_height - size.height - 10;
...
{
    WBCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
...
{
    int itemIndex = (scrollView.contentOffset.x + self.mainView.wb_width * 0.5) / self.mainView.wb_width;
